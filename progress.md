...
**Проверено локально:** eslint 0/0, tsc, vitest unit 62 файла / 999 тестов,
components 35 файлов / 123 теста, `vite build`, регенерация openapi.json.
**Go не собирался** — в окружении ревью нет Go 1.26; гейт закрывает `make verify` + CI.
