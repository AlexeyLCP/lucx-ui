  ...
  useEffect(() => {
    ...
    if (isEdit && client) {
      ...
      const seed: Values = {
        ...
        wgKeepAlive:
          client.keepAlive != null && client.keepAlive !== '' ? String(client.keepAlive) : '0',
                ...
                },
                {
                  ...
                  children: (
                    <>
                      ...
                      {(showWireguard || showAmneziawg || showAwg) && (
                        <>
                          <Form.Item
                            label={t(
                              showAmneziawg
                          ...
                          >
                            <Space.Compact style={{ display: 'flex' }}>
                              ...
                              <Button
                                aria-label={t('regenerate')}
                                icon={<ReloadOutlined />}
                                onClick={showAwg ? regenerateAwgKeys : regenerateWireguardKeys}
                              />
                            </Space.Compact>
                          </Form.Item>
                          <FormField
                          ...
                          {showWireguard && showAmneziawg ? (
                            <>
                              ...
                              >
                                <Input
                                  placeholder={showAwg ? awgAllowedIPsPlaceholder : '10.0.0.2/32'}
                                />
                              </FormField>
                              <FormField
                                name="awgAllowedIPs"
                            ...
                            >
                              <Input
                                placeholder={showAwg ? awgAllowedIPsPlaceholder : '10.8.1.2/32'}
                              />
                            </FormField>
                          )}
