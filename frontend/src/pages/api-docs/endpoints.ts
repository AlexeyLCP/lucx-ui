        ...
        params: [
          {
            ...
            in: 'body',
            type: 'string',
            desc: 'Obfuscation preset: "lite", "standard", or "pro".',
          },
          {
            name: 'mimicryProfile',
            in: 'body',
            type: 'string',
            desc: 'CPS mimicry type: "tls", "dns", "sip", or "quic".',
          },
          {
            name: 'browserProfile',
            in: 'body',
            type: 'string',
            desc: 'CPS browser fingerprint: "chrome", "firefox", or "safari".',
          },
          {
            name: 'region',
            in: 'body',
            type: 'string',
            desc: 'Domain pool region: "ru" or "world".',
          },
          {
            name: 'domain',
            in: 'body',
            type: 'string',
            desc: 'Optional explicit domain for CPS capture.',
          },
          {
            name: 'fullI1I5',
            in: 'body',
            type: 'boolean',
            desc: 'When true, generate all five CPS packets; when false, only I1.',
          },
          {
            name: 'awgVersion',
            in: 'body',
          ...
          },
          {
            ...
            type: 'number',
            optional: true,
            desc: 'Host the inbound will run on: null or omitted = this panel (the AWG3 block then needs local module support), a node ID = node-hosted (the node judges its own AWG3 support).',
          },
        ],
      },
      {
        ...
        params: [
          {
            ...
            in: 'body',
            type: 'string',
            desc: 'Domain to probe (QUIC Initial with TLS SNI=domain).',
          },
          {
            name: 'region',
            in: 'body',
            type: 'string',
            desc: 'Domain pool region for fallback: "ru" or "world".',
          },
          {
            name: 'nodeId',
            in: 'body',
            type: 'number',
            optional: true,
            desc: 'Host the inbound will run on: null or omitted = this panel, a node ID = node-hosted. Same meaning as on generateObfuscation — it decides whether the I1-I5 budget leaves room for a header-protection key.',
          },
        ],
      },
