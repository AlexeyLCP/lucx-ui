      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            in: 'body',
            type: 'string',
            desc: 'Target AmneziaWG version: "1.5", "2", "3", or "3.1". When "3" or "3.1" (and the host supports AWG3) the response adds headerProtectionKey plus the six timer/padding ranges. RandomTrailers is never auto-enabled (must-match; current GUI clients drop the handshake).',
          },
        ],
      },
      {
