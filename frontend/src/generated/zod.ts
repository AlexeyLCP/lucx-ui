...
export const InboundSchema = z.object({
  ...
  port: z.number().int().min(0).max(65535),
  protocol: z.enum(['vmess', 'vless', 'trojan', 'shadowsocks', 'wireguard', 'hysteria', 'http', 'mixed', 'tunnel', 'tun', 'mtproto', 'amneziawg', 'awg', 'naive', 'olcrtc', 'qwdtt', 'mieru', 'trusttunnel', 'anytls']),
  remark: z.string(),
  settings: z.unknown(),
  shareAddr: z.string(),
