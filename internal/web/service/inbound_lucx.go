...
func inboundHasSidecar(p model.Protocol) bool {
	switch p {
	case model.AWG, model.MTProto, model.Naive, model.Olcrtc, model.Qwdtt, model.Csqtt, model.Mieru, model.TrustTunnel, model.Anytls, model.Tproxy, model.Cover:
		return true
	default:
		return false
	}
...
func lucxRuntimeSidecar(p model.Protocol) bool {
	...
	case model.AWG, model.AmneziaWG, model.Naive, model.Olcrtc, model.Qwdtt, model.Csqtt,
		model.Mieru, model.TrustTunnel, model.Anytls, model.Tproxy, model.Cover:
		return true
	}
	return false
}
