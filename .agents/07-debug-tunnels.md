...
- **lucx.199:** pin moved to `ebe518a2af2d3c5da4d55c3872f8f3298a4d2f45` (OLC2). Server now speaks OLC2. Old owenclave / pre-16.08 olcbox → `muxconn: decrypt failed` / `chacha20poly1305: message authentication failed` (VladufQa, 01.09.2026). Client must be olcbox nightly 16.08.2026+. YAML/URI unchanged.
