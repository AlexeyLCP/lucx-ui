...
### Pattern 1d: AWG inbound «Device awgN does not exist» когда оператор выбрал v3 на v1.x module — ИСПРАВЛЕНО (lucx.52.1)
