...
- **Не делаем:** server-side guard / отказ в сохранении dup-subnet (намеренно — ломает back-compat; оператор может сознательно хотеть пересечение). Auto-suggest следующей свободной /24 — follow-up, если warning окажется недостаточным.
